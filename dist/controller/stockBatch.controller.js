...
exports.getStockAlerts = exports.getStockBatchesByProductId = exports.getStockStats = exports.toggleStockArchive = exports.deleteStockBatch = exports.updateStockBatch = exports.getStockBatchById = exports.getStockBatches = exports.createStockBatch = void 0;
const client_1 = require("@prisma/client");
const prisma = new client_1.PrismaClient();
// Create a new stock entry
const createStockBatch = async (req, res) => {
    try {
        const { productId, manufacturingDate, arrivalDate, validityMonths, supplierName, supplierId, stockQuantity, isArchived, } = req.body;
...
const getStockBatches = async (req, res) => {
    try {
        const { page = 1, limit = 10, search, productId, supplierName, isArchived, expired, lowStock, } = req.query;
...
exports.getStockBatches = getStockBatches;
...
exports.getStockBatchById = getStockBatchById;
...
exports.updateStockBatch = updateStockBatch;
...
exports.deleteStockBatch = deleteStockBatch;
// Archive/Unarchive stock
const toggleStockArchive = async (req, res) => {
    try {
        const { id } = req.params;
...
exports.toggleStockArchive = toggleStockArchive;
// Get stock statistics
const getStockStats = async (req, res) => {
    try {
        const [totalStockBatches, totalValue, expiredStocks, lowStockCount, archivedStockBatches,] = await Promise.all([
        ...
        const totalInventoryValue = stocksWithProducts.reduce((sum, stock) => sum + (stock.product.mrp * stock.stockQuantity), 0);
        res.json({
            stats: {
                totalStockBatches,
...
const getStockBatchesByProductId = async (req, res) => {
    try {
        ...
        const { page = 1, limit = 100, isArchived, expired, lowStock, } = req.query;
        // Convert string values to numbers
        const pageNum = parseInt(page, 10) || 1;
        const limitNum = parseInt(limit, 10) || 10;
        const skip = (pageNum - 1) * limitNum;
...
exports.getStockBatchesByProductId = getStockBatchesByProductId;
...
//# sourceMappingURL=stockBatch.controller.js.map